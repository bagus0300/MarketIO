...
def add_product(request):
    ...
    return render(request, "products/add_product.html", {"product_form": product_form, "image_form": image_form, "variant_choices": variant_choices})
...
def edit_product(request, product_id):
    ...
    variant_choices = ProductVariant.SIZES
    variants_data = [{'size': variant.size, 'quantity': variant.quantity} for variant in product.variants.all()]
